...
public class Safari_P1 {
	...
	static String email = "superlulu@mail.ru";
	static String password = "Eva51.70.72";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String friends = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"u_0_1a\"]/li[3]/a/span[1]"))).getText();
